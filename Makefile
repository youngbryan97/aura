...
subject-core-integrity:
	@echo "🔬 Checking that nothing under measurement can see the instrument..."
...
qualification-seals:
	@echo "🔏 Checking the code under every qualified claim..."
	@$(PYTHON) tools/lint_qualification_seals.py
