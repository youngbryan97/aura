...
from .agency_shard_work import _RunsOneShard
...
def _close_if_possible(awaitable: Any) -> None:
    try:
        ...
        return  # not a failure: nothing to close, which is this helper's job
    try:
        close()
...
class SovereignSwarm(_RunsOneShard):
...
class AgencyCore:
    ...
    def heartbeat(self) -> None:
        ...
        if in_flight is not None:
            try:
                ...
                pass  # not a failure: an object that cannot answer is not evidence
    ...
    def _pathway_cognitive_loop(
        ...
        try:
            ...
            return None  # not a failure: no record to judge worth from
    ...
    def _degraded_reasons(self) -> list[str]:
        ...
        if loop_task is not None:
            try:
                ...
                pass  # not a failure: a double that cannot answer is not evidence
        return reasons
    ...
    def is_alive(self) -> bool:
        ...
        try:
            ...
            return False  # not a failure: an unreadable status is not alive
        return (
