...
from core.brain.llm.latent_cortex.action_state_capture import (
    UnknownActionStateApplicationError,  # noqa: F401  (read at call time by the lifted module)
)
...
from core.brain.llm.latent_cortex.loop_core import (
    ...
    ComputeBudgetUnaffordable,  # noqa: F401  (read at call time by the lifted module)
)
...
from core.brain.llm.latent_cortex.types import (
    ...
    ComputeBudget,  # noqa: F401  (read at call time by the lifted module)
    CortexConfig,
    EpisodeReceipt,  # noqa: F401  (read at call time by the lifted module)
    LatentReasoningResult,  # noqa: F401  (read at call time by the lifted module)
)
from core.brain.llm.latent_cortex.value_of_computation import (
    ACTION_TRANSITION_SCHEMA,
    CognitiveStateSignal,
    ValueOfComputationPolicy,
    build_evidence_snapshot,  # noqa: F401  (read at call time by the lifted module)
    transition_reward,
    validate_evidence_snapshot,  # noqa: F401  (read at call time by the lifted module)
)
...
from .engine_episode import _ReasonsThroughAnEpisode
...
class LatentCortexEngine(_ReasonsThroughAnEpisode):
        ...
        if messages:
            ...
            return self._validate_token_ids(
                self.tokenizer.apply_chat_template(
                    for_this_template(self.tokenizer, messages),
    ...
    reason.__wrapped__ = _ReasonsThroughAnEpisode._reason_episode
