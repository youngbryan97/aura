...
from core.brain.llm import model_paths  # noqa: F401  (read at call time by the lifted module)
...
from core.brain.llm.model_paths import (
    BASE_DIR,
    get_fused_model_root,  # noqa: F401  (read at call time by the lifted module)
    get_models_dir,
)
...
from .model_registry_deep_solver import (  # noqa: F401  (re-exported: they were defined here)
    _current_specialist_source_commit,  # noqa: F401  (read at call time by the lifted module)
    _deep_specialist_identity_signature,  # noqa: F401  (read at call time by the lifted module)
    _path_stat_signature,  # noqa: F401  (read at call time by the lifted module)
    deep_solver_artifact_is_ready,  # noqa: F401  (read at call time by the lifted module)
    deep_solver_is_distinctly_configured,  # noqa: F401  (read at call time by the lifted module)
    get_deep_solver_admission_status,
    get_deep_specialist_certificate_path,  # noqa: F401  (read at call time by the lifted module)
    get_deep_specialist_trust_root_path,  # noqa: F401  (read at call time by the lifted module)
)
