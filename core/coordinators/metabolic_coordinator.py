...
from core.runtime.background_policy import (
    IDLE_COGNITION_BACKGROUND_POLICY,  # noqa: F401  (read at call time by the lifted module)
    background_activity_reason,  # noqa: F401  (read at call time by the lifted module)
)
from core.runtime.errors import record_degradation
from core.runtime.impulse_governance import (
    run_governed_impulse,  # noqa: F401  (read at call time by the lifted module)
)
from core.runtime.safe_mode import (  # noqa: F401  (read at call time by the lifted module)
...
from .metabolic_impulses import _TriggersTheImpulses
...
class MetabolicCoordinator(_TriggersTheImpulses):
