...
import mlx.core as mx  # noqa: F401  (read at call time by the lifted module)
import mlx.nn as nn
...
from core.learning.recurrent_literal_grounding import (
    LITERAL_MAX_VALUE,  # noqa: F401  (read at call time by the lifted module)
...
from .unified_intrinsic_microcode import (  # noqa: F401  (re-exported: they were defined here)
    _microcode_transition_logits_calibration_input,
    _microcode_transition_logits_is_audit,
    _microcode_transition_logits_is_simulate,
    _microcode_transition_logits_modulus,
    _microcode_transition_logits_op_causal_chain,
)
from .unified_intrinsic_recurrence_construction import _BuildsItsRegisters
...
class UnifiedRecurrentController(_BuildsItsRegisters, nn.Module):
    ...
    def microcode_transition_logits(
        ...
        *,
        ...
        register_result, value0 = _microcode_transition_logits_modulus(arg0, arg1, arg2, arg3, arg4, arg5, opcode, state, value0)
        ...
        inferred_role, is_infer = _microcode_transition_logits_is_simulate(self, action_probability_history, arg0, arg1, arg2, opcode, value0, values)
        ...
        if action_probability_history is not None:
            percentage = _microcode_transition_logits_calibration_input(action_probability_history, is_calibrate, state, values)

        candidate_encoded, candidate_score = _microcode_transition_logits_is_audit(arg0, arg1, arg2, arg3, arg4, opcode, state, values)
        ...
        semantic_invalid = _microcode_transition_logits_op_causal_chain(arg0, arg1, arg2, arg3, arg4, arg5, opcode, semantic_invalid, values)
...
def _unified_recurrent_hidden_states_part_1(
    controller: UnifiedRecurrentController,
    detach_problem_evidence: bool,
    initial_state_logit_trajectory: list[Any] | None,
    initial_state_teacher_values: Sequence[int] | None,
    problem_evidence: Any,
    state_slot_start: int | None,
...
def _unified_recurrent_hidden_states_action_probabilities(
    action_logits: Any,
    action_probability_history: list[Any],
    action_teacher_values: Sequence[Sequence[int]] | None,
    controller: UnifiedRecurrentController,
    iteration: Any,
    public_action_values: Sequence[Sequence[int]] | None,
    state_teacher_forcing_probability: float,
    typed_action_lesion: bool,
) -> tuple[Any, Any]:
...
def _unified_recurrent_hidden_states_part_3(
    action_state: Any,
    active: Any,
    controller: UnifiedRecurrentController,
    hidden: Any,
