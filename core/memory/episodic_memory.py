...
from core.memory.hippocampus import (
    HippocampalIndex,  # noqa: F401  (read at call time by the lifted module)
)
...
from .episodic_recall import _RecallsEpisodes
...
class EpisodicMemory(_RecallsEpisodes, _RanksWhatToRecall):
