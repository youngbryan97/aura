...
from core.organism.closeout_canaries import (  # noqa: F401 — the registry binds these; tests read them here
    _canary_artifact_bundle,
    _historical_semantic_sources_hold,
    _historical_semantic_sources_hold_at_binding,
...
from core.organism.nothing_measured import NothingMeasured  # noqa: F401 — every caller reads it from here
