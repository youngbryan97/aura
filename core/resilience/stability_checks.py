"""One check per subsystem the guardian watches.

Lifted whole out of `stability_guardian`. Every name taken from it is imported at
...
if TYPE_CHECKING:
    from .stability_guardian import (
        HealthCheckResult,
    )


class _ChecksEachSubsystem:
    """Lifted whole out of StabilityGuardian; see stability_guardian.py."""
