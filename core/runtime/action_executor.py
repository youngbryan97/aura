...
from core.runtime.errors import (
    ...
    _raise_site,  # noqa: F401  (read at call time by the lifted module)
...
from core.runtime.post_action_receipt import (
    PostActionReceipt,  # noqa: F401  (read at call time by the lifted module)
    get_post_action_receipt_store,
)
from core.runtime.skill_contract import (
    ActionExpectation,
    SkillStatus,  # noqa: F401  (read at call time by the lifted module)
...
from .action_executor_steps import _RunsTheActionSteps
...
class ActionExecutor(_RunsTheActionSteps):
        ...
        *,
        ...
        try:
            if deliberation_worthy_action:
                ...
                external_execution_transaction = await cls._execute_part_1(action_name, action_summary, domain, expectation_contract, external_execute_coordinator, external_execution_offer, external_execution_transaction, preaction_thread)
            ...
            if (
                ...
                failure_result = cls._execute_part_2(action_id, action_name, exc, expectation_contract, external_execution_transaction, request_digest, will_receipt_id)
                return await _finalize_approved_no_effect(
        ...
        try:
            ...
            async with governed_scope(decision, ttl=governance_ttl_s):
                ...
                if external_execution_offer is not None:
                    external_dispatch_attempt_id, external_execution_transaction = await cls._execute_begin_task(external_execute_coordinator, external_execution_offer, external_execution_transaction, will_receipt_id)
            ...
            result = cls._execute_part_4(action_name, dispatch_result, exc)
        ...
        final_status, final_transport_succeeded = await cls._execute_part_5(action_name, external_dispatch_attempt_id, external_dispatch_heartbeat, external_execute_coordinator, external_execution_offer, external_execution_transaction, post_receipt, result)
        final_effect_verified = result.get("effect_verified") is True
        final_error_msg, post_receipt = cls._execute_final_error_msg(final_effect_verified, final_status, final_transport_succeeded, post_receipt, result)
        ...
        await cls._execute_part_7(action_name, external_execute_coordinator, external_execution_offer, persisted_post_receipt, post_receipt, receipt_store, result)
        return result
