...
def install_runtime_providers() -> list[str]:
    """Register the providers that say what each discipline is holding.

    The providers live in `core/runtime/memory_providers.py`; this stays as
    the name every caller and test already uses.
    """
    from core.runtime.memory_providers import install_runtime_providers as install
