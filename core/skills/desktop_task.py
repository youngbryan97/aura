...
from .desktop_task_reading import _ReadsTheObjective
import asyncio
import hashlib
import json
import logging
...
from core.language.concepts import (
    extract_object_description,  # noqa: F401  (read at call time by the lifted module)
    mentions_object_class,  # noqa: F401  (read at call time by the lifted module)
...
from core.runtime.desktop_objective_intent import (
    ...
    looks_like_screen_observation,  # noqa: F401  (read at call time by the lifted module)
)
...
class DesktopTaskSkill(_ReadsTheObjective, _ResearchesBeforeItWrites, BaseSkill):
