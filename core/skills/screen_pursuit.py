...
from core.cognition.the_ones_she_reaches_for import (
    TheOnesSheReachesFor,  # noqa: F401  (read at call time by the lifted module)
)
...
from core.runtime.what_she_learned import (  # noqa: F401  (read at call time by the lifted module)
    TRUST_CARRIED_OVER,
    named,
    recall,
    remember,
...
from .screen_pursuit_bearings import (
    ...
    SLOW_DOWN,  # noqa: F401
    START_OVER,  # noqa: F401  (read at call time by the lifted module)
...
from .screen_pursuit_surface import (
    ...
    click_normalized,  # noqa: F401  (read at call time by the lifted module)
    goal_reached,
...
async def pursue_on_screen(
    *,
    ...
    from core.perception.where_it_responds import describe, what_is_there
    ...
    reaches, responds = _pursue_on_screen_where_her_actions(knew, knows, skilled, world)
    ...
    if not moves:
        ...
        if first.get("ok") and satisfied(first):
            ...
            if fresh is not None:
                ...
                began = await _pursue_on_screen_part_2(already, anchor, began, first, fresh, intending, restarts, settle, target_app)
            else:
                already["value"] = True
    ...
    _pursue_on_screen_part_5(began_at, cannot_explain, endings, narrate, pending, plan, result, trying)
