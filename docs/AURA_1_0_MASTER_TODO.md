...
- [ ] I06 Link each release requirement to an executable acceptance check.
  ...
  33 linked, 280 unlinked (279 of them mandatory), 0 broken links.
  ...
  count falls or a link stops resolving. The remaining 280 are the release
  programme itself — ACTION-SPINE-001, ADAPT-001, the ADDENDUM series — not a
  bookkeeping gap, so this stays open.
