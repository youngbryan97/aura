...
| Wave3 #16 | P0 | 178,382 lines of module oversize against a budget of 145,896, and 38 files over their own baseline | The one number the ratchet holds, growing under several hands. Four modules over the 2,000-line ceiling created since the baseline and six classes over the 30-method ceiling: those are what the gate was written to stop and they are the tractable half. | TODO |
