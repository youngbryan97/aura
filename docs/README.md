...
| [runbooks/](runbooks/) | 41 incident procedures, one per known failure mode. Written against `aura doctor --bundle` fields |
...
- **Subsystem deep dives** —
  [MEMORY_ARCHITECTURE.md](MEMORY_ARCHITECTURE.md) (116-module memory subsystem),
  [REASONING_ENGINES.md](REASONING_ENGINES.md) (deterministic reasoning, sandboxed execution, and what's out of the model's hands)
