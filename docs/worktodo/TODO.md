...
| 2 | `InteriorityService.apply()` — the general effect bus (affect, somatic, goals, curiosity, action filtering, cognitive budget) has no production caller | OPEN |
| 3 | Stream of Being: LLM narrative can become evidence for the state it was generated from. Self-confirming phenomenology | OPEN |
