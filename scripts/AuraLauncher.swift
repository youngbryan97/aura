...
final class AuraLauncherDelegate: NSObject, NSApplicationDelegate,
    ...
    private func baseAuraEnvironment() -> [String: String] {
        ...
        env["AURA_MEMWATCH_SOFT_MB"] = "37888"
        env["AURA_MEMWATCH_HARD_MB"] = "41984"
        ...
        env["AURA_GOVERNOR_CRITICAL_MB"] = "40960"
    ...
    private func spawnViaTerminal(arguments: [String]) throws {
        ...
        export AURA_MEMWATCH_SOFT_MB=37888
        export AURA_MEMWATCH_HARD_MB=41984
        ...
        export AURA_GOVERNOR_CRITICAL_MB=40960
