...
final class AuraLauncherDelegate: NSObject, NSApplicationDelegate,
    ...
    private func baseAuraEnvironment() -> [String: String] {
        ...
        env["AURA_DESKTOP_PROCESS_RSS_RATIO"] = "0.81"
        env["AURA_DESKTOP_PROCESS_RSS_CAP_GB"] = "56"
        env["AURA_DESKTOP_HOST_RESERVE_RATIO"] = "0.18"
        env["AURA_DESKTOP_HOST_RESERVE_FLOOR_GB"] = "8"
        env["AURA_DESKTOP_PROCESS_RSS_FLOOR_GB"] = "24"
        env["AURA_PROCESS_RSS_LIMIT_GB"] = "auto"
        env["AURA_MEMWATCH_SOFT_MB"] = "auto"
        env["AURA_MEMWATCH_HARD_MB"] = "auto"
        env["AURA_MEMWATCH_LETHAL_MB"] = "auto"
        env["AURA_MEMORY_SENTINEL_INTERVAL_S"] = "0.5"
        env["AURA_GOVERNOR_PRUNE_MB"] = "auto"
        env["AURA_GOVERNOR_UNLOAD_MB"] = "auto"
        env["AURA_GOVERNOR_CRITICAL_MB"] = "auto"
    ...
    private func spawnViaTerminal(arguments: [String]) throws {
        ...
        export AURA_DESKTOP_PROCESS_RSS_RATIO=0.81
        export AURA_DESKTOP_PROCESS_RSS_CAP_GB=56
        export AURA_DESKTOP_HOST_RESERVE_RATIO=0.18
        export AURA_DESKTOP_HOST_RESERVE_FLOOR_GB=8
        export AURA_DESKTOP_PROCESS_RSS_FLOOR_GB=24
        export AURA_PROCESS_RSS_LIMIT_GB=auto
        export AURA_MEMWATCH_SOFT_MB=auto
        export AURA_MEMWATCH_HARD_MB=auto
        export AURA_MEMWATCH_LETHAL_MB=auto
        export AURA_MEMORY_SENTINEL_INTERVAL_S=0.5
        export AURA_GOVERNOR_PRUNE_MB=auto
        export AURA_GOVERNOR_UNLOAD_MB=auto
        export AURA_GOVERNOR_CRITICAL_MB=auto
